...
const AboutText = () => {
  return (
    <div className="about-section p-4 space-y-6">
      ...
      <ul className="list-decimal pl-5 space-y-3">
        <li className="text-base">
          ...
          curate the ideal soundtrack and atmosphere, ensuring your event
        ...
        <li className="text-base">
          ...
          first dance or a tailored business jingle, we craft it with precision.
        </li>
        <li className="text-base">
